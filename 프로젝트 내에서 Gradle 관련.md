...
--
 ...
 - [목차](#목차)
 - [전체 플로우](#전체-플로우)
  - [프로젝트 내에서 Gradle 관련 파일](#프로젝트-내에서-Gradle-관련-파일)
     - [1) settings.gradle 파일](#1)-settings.gradle-파일)
     - [2) 루트 프로젝트 디렉토리의 build.gradle 파일 (최상위 빌드 파일)](#2)-루트-프로젝트-디렉토리의-build.gradle-파일-(최상위-빌드-파일))
