...
--
 ...
 - [목차](#목차)
 - [전체 플로우](#전체-플로우)
  - [AndroidManifest.xml 란?](#AndroidManifest.xml-란?)
     - [앱의 패키지 이름](#앱의-패키지-이름)
     - [앱의 구성요소](#앱의-구성요소)
        - [번외) Intent 란?](#번외)-Intent-란?)
        - [번외) 명시적 인텐트](#번외)-명시적-인텐트)
        - [번외) 암시적 인텐트](#번외)-암시적-인텐트)
     - [앱이 다른 부분에 액세스하기 위해 필요한 권한](#앱이-다른-부분에-액세스하기-위해-필요한-권한)
     - [앱에 필요한 하드웨어/소프트웨어 기능 알림](#앱에-필요한-하드웨어/소프트웨어-기능-알림)
